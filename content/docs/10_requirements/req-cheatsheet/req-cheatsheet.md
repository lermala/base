...
**Заинтересованное лицо (стейкхолдер)** — это любой человек или организация, которые заинтересованы в проекте или влияют на него (прямо или косвенно). Примеры стейкхолдеров: руководство, пользователи, техническая поддержка, партнеры/внешние системы.
